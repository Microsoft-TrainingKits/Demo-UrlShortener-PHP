...
In this demonstration, you will look at setting up a PHP website in Windows Azure Websites. The purpose of this site will be to function as the backend for mobile applications. This demonstration will show websites, MySQL databases, and deployment using GIT.
...
If you find any issues with this demo that you can't fix, feel free to report them in the [issues](https://github.com/WindowsAzure-TrainingKit/Demo-UrlShortener-PHP/issues) section of this repository.